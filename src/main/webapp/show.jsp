	...
	<div id="content_sec">
    	<div class="categories1">
        	<h3 class="heading colr">All Recent Events</h3>
             ...
             <ul>
                 <s:actionerror/>
                 <div  style=" width: 815px; height: 470px">            
                     <div class="col1" style=" width: 215px;">
                       <s:iterator value="showmlist" status="ll" >
                        <li class="last">
                         <s:url action="viewshowstalls.action" var="viewshowstalls">
                               <s:param name="showid" value="%{getShow().getShowId()}" />
                         </s:url>
                         <div >                                    
                	 <s:a  href="%{viewshowstalls}" onclick="window.open(this.href, 'child', 'scrollbars,width=650,height=600'); return false" class="thumb"><img src="shimg.action?showimg=<s:property value="%{getShow().getShowId()}"/>" onerror="this.src='images/cat_img3.gif';" height="194" width="215" /></s:a>
                         </div>
                         
                         <div class="descr" >      
                             <h4 align="center"><s:property value="%{getShow().getShowname()}" /></h4>
                         </div>
                        </li> 
                 ...
                 <s:iterator value="showmlist" status="ll" >
                     ...
                     <div  class="descr1" style=" border-bottom:  none; height: 220px;" >  
                         
                         <p class="balahed" >Event name:&nbsp;&nbsp;<s:property value="%{getShow().getShowname()}" /></p><br/><br/><br/><br/>
                         <p class="bala">Event Type:&nbsp;&nbsp;<s:property value="%{getShow().getShowtype()}" /></p><br/><br/>
                         <p class="bala">Event Date:&nbsp;&nbsp;<s:property value="%{showdate}" /></p><br/><br/>
                         <p class="bala">Event Location:&nbsp;&nbsp;<s:property value="%{venue}" /></p>
                         <s:property value="getShow().getStalls().get(0)" />
                     </div>
                 </s:iterator>
                 </div>
                 </div>
