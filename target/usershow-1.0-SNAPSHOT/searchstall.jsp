             ...
             <ul>
                 ...
                 <div  style=" width: 815px;">            
                     <div class="col1" style=" width: 215px; ">
                       <s:iterator value="stallnmlist" status="ll" >
                           <div style=" height: 130px;" >
                           <li class="last" style=" " >
                               <s:url action="viewstall.action" var="viewstall">
                                      <s:param name="stallid" value="%{getStallId()}" />
                          </s:url>
                         <div >                                    
                	 <s:a  href="%{viewstall}" class="thumb"><img src="stallsrchimg.action?stallsrchimg=<s:property value="%{getStallId()}"/>" onerror="this.src='images/cat_img3.gif';" height="194" width="215" /></s:a>
                         </div>
                         
                         <div class="descr" style=" height: 5px;" >      
                             <h4 align="center"><s:property value="%{getStallname()}" /></h4>
                         </div>
                        </li> 
                           </div>
                       </s:iterator>
                 ...
                 <s:iterator value="stallnmlist" status="ll" >
                     ...
                     <div  class="descr1" style=" border-bottom:  none; height: 215px;" >  
                         ...
                         <p class="balahed" >Sales Outlet name:&nbsp;&nbsp;<s:property value="%{getStallname()}" /></p><br/><br/><br/><br/>
                         <p class="bala">Sales Outlet Type:&nbsp;&nbsp;<s:property value="%{getShow().getShowtype()}" /></p><br/><br/>
