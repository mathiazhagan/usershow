<%-- 
    Document   : static
    Created on : Nov 13, 2011, 3:03:16 PM
...
<div id="wrapper_sec">
    ...
    <!-- Content Section -->
	 <div id="content_sec">
    	<h3 class="heading colr">About Us</h3>
        <div class="static">
            <h4>We Have All Updated Events takes place in all parts of the World</h4>
            <p>	&nbsp;&nbsp;&nbsp;In this site we see all the details about the events Trade Fairs takes place.<br /><br />
&nbsp;</p>
            <div class="left_sec">
                <ul>
